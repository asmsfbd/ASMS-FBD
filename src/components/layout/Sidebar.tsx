...
const navItems: NavItem[] = [
  {
    ...
    roles: ['aso', 'centre_admin', 'scanner', 'jatha_sewadar'],
  },
  {
    label: 'Sewadars',
    labelHi: 'सेवादार',
    to: '/sewadars',
    icon: <Users size={16} />,
    roles: ['aso', 'centre_admin'],
  },
  {
    label: 'Daily Duty',
    labelHi: 'दैनिक ड्यूटी',
    to: '/scanner',
    icon: <ScanLine size={16} />,
    roles: ['scanner', 'aso'],
  },
  {
    label: 'Jatha Schedule',
    labelHi: 'जत्था शेड्यूल',
    to: '/jatha-schedule',
  ...
  {
    label: 'Jatha Attendance',
    labelHi: 'जत्था हाजिरी',
    to: '/jatha-attendance',
    icon: <CheckSquare size={16} />,
    roles: ['jatha_sewadar', 'aso', 'centre_admin'],
  },
  {
    label: 'Reports',
    labelHi: 'रिपोर्ट',
...
const roleLabels: Record<Role, { en: string; hi: string; color: string }> = {
  aso:            { en: 'Area HQ',       hi: 'क्षेत्र मुख्यालय', color: 'bg-gold-500 text-maroon-800' },
  centre_admin:   { en: 'Centre Admin',  hi: 'केंद्र प्रबंधक',    color: 'bg-navy-500 text-white' },
  scanner:        { en: 'Scanner',       hi: 'स्कैनर',             color: 'bg-green-600 text-white' },
  jatha_sewadar:  { en: 'Jatha Sewadar', hi: 'जत्था सेवादार',    color: 'bg-purple-600 text-white' },
}
...
export function Sidebar() {
  ...
  return (
    <aside className="w-56 min-h-screen bg-maroon-700 flex flex-col select-none">
      ...
      {/* Logo */}
      <div className="px-4 py-4 border-b border-maroon-600">
      ...
      <div className="px-4 py-3 border-b border-maroon-600 bg-maroon-800/30">
        ...
        <p className="text-white/40 text-[10px] mt-0.5 truncate">{user.centre}</p>
      </div>
      ...
      <div className="p-3 border-t border-maroon-600">
        <button
          ...
          className="w-full flex items-center gap-2.5 px-3 py-2 rounded-lg text-white/50 hover:text-white hover:bg-white/8 text-sm transition-all duration-150"
        >
          <LogOut size={15} />
          <span>Sign Out</span>
        </button>
